...
import { loadLawPlatformHealthSummary } from "@/lib/law-platform-health";
import { loadLawPersistenceDiagnostics } from "@/lib/persistence/persistence-diagnostics";
...
export async function GET() {
  ...
  const [
    ...
    loadLawPlatformHealthSummary().catch(() => undefined),
    loadLawPersistenceDiagnostics().catch(() => undefined),
  ]);

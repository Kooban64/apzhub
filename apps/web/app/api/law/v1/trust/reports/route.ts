...
export const GET = withLawApiAuth(handleListTrustReports, TRUST_LIST_AUTH);
export const POST = withLawApiAuth(handleGenerateTrustReport, TRUST_REPORT_CREATE_AUTH);

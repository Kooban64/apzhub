...
export const GET = withPlatformApiAuth(handleListConfigurationGroups, {
  operation: "configuration.groups.list",
});

export const POST = withPlatformApiAuth(handleCreateConfigurationGroup, {
  operation: "configuration.groups.create",
});

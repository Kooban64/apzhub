...
import { buildPlatformAdminTenantProducts } from "@/lib/platform-admin/build-tenant-commercial";
...
export async function GET(
  ...
  try {
    const data = await buildPlatformAdminTenantProducts(tenantId);
    if (!data) {

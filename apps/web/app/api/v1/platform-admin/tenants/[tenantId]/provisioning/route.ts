...
import { buildPlatformAdminTenantProvisioning } from "@/lib/platform-admin/build-tenant-provisioning";
...
export async function GET(
  ...
  try {
    const data = await buildPlatformAdminTenantProvisioning(tenantId);
    if (!data) {

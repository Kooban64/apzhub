...
/**
 * APZ Time product preferences only — never engine/adapter configuration.
 */
export function TimeSettingsView() {
  ...
  return (
    <PageShell
      title="Settings"
      description="Preferences for how APZ Time appears in your workspace."
      breadcrumbs={["APZ Time", "Settings"]}
    >
      <form
        className="flex max-w-xl flex-col gap-4 rounded-lg border border-[var(--color-border)] p-4"
        data-testid="time-settings"
        onSubmit={(event) => {
      ...
      >
        <label className="flex items-start gap-3 text-sm">
          <input
            ...
            data-testid="time-settings-compact"
          />
          <span>
            ...
            <span className="mt-0.5 block text-[var(--color-muted-foreground)]">
              Prefer denser spacing in timesheet tables when available.
            </span>
          </span>
        </label>
        ...
        <label className="flex items-start gap-3 text-sm">
          <input
            ...
            data-testid="time-settings-onboarding"
          />
          <span>
            <span className="font-medium text-[var(--color-foreground)]">
            ...
            <span className="mt-0.5 block text-[var(--color-muted-foreground)]">
              Dismiss the Overview getting-started guidance for this browser.
            </span>
          </span>
        </label>
        ...
        <div className="flex items-center gap-3">
          <Button type="submit" size="sm" data-testid="time-settings-save">
            Save preferences
          </Button>
          {saved ? (

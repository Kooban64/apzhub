/**
 * SUP-PR-05 — fail-closed Support API permission gate (session grants only).
 */
...
/** Require at least one of the listed Support permissions from the session. */
...
export function supportSessionTenantId(context: PlatformApiRequestContext): string {

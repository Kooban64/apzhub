...
export const createHealthChecksBodySchema = z
  .object({
...
export const updateHealthChecksBodySchema = z
  .object({
...
export const createReadinessChecksBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256),
    name: z.string().min(1).max(256),
...
export const updateReadinessChecksBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256).nullable().optional(),
    name: z.string().min(1).max(256).optional(),
...
export const createLivenessChecksBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256),
    name: z.string().min(1).max(256),
...
export const updateLivenessChecksBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256).nullable().optional(),
    name: z.string().min(1).max(256).optional(),
...
export const createServiceHealthBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256),
...
export const updateServiceHealthBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256).nullable().optional(),
...
export const createServiceStatusBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256),
    status: observeHealthStatusSchema,
    organisationId: z.string().min(1).max(256).optional(),
...
export const createComponentStatusBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256),
...
export const updateComponentStatusBodySchema = z
  .object({
    serviceKey: z.string().min(1).max(256).nullable().optional(),
...
export const createMetricDefinitionsBodySchema = z
  .object({
...
export const updateMetricDefinitionsBodySchema = z
  .object({
...
export const createMetricSamplesBodySchema = z
  .object({
...
export const updateMetricSamplesBodySchema = z
  .object({
...
export const createAlertDefinitionsBodySchema = z
  .object({
    key: z.string().min(1).max(256),
    name: z.string().min(1).max(256),
...
export const updateAlertDefinitionsBodySchema = z
  .object({
    key: z.string().min(1).max(256).optional(),
    name: z.string().min(1).max(256).optional(),
...
export const createAlertStatesBodySchema = z
  .object({
...
export const updateAlertStatesBodySchema = z
  .object({
    alertDefinitionId: z
      .string()
      .min(1)
...
export const updateDashboardDefinitionsBodySchema = z
  .object({
    key: z.string().min(1).max(256).optional(),
    name: z.string().min(1).max(256).optional(),
    providerKind: observeProviderKindSchema.optional(),
...
export const createLogSourcesBodySchema = z
  .object({
    key: z.string().min(1).max(256),
    name: z.string().min(1).max(256),
...
export const updateLogSourcesBodySchema = z
  .object({
    key: z.string().min(1).max(256).optional(),
    name: z.string().min(1).max(256).optional(),
...
export const createTraceDefinitionsBodySchema = z
  .object({
    key: z.string().min(1).max(256),
    name: z.string().min(1).max(256),
    providerKind: observeProviderKindSchema,
...
export const updateTraceDefinitionsBodySchema = z
  .object({
    key: z.string().min(1).max(256).optional(),
    name: z.string().min(1).max(256).optional(),
    providerKind: observeProviderKindSchema.optional(),
...
export const createTraceSpansBodySchema = z
  .object({
...
export const updateTraceSpansBodySchema = z
  .object({
...
export const createIncidentReferencesBodySchema = z
  .object({
    key: z.string().min(1).max(256),
...
export const updateIncidentReferencesBodySchema = z
  .object({
    key: z.string().min(1).max(256).optional(),
...
export const createMaintenanceWindowsBodySchema = z
  .object({
    key: z.string().min(1).max(256),
    name: z.string().min(1).max(256),
...
export const updateMaintenanceWindowsBodySchema = z
  .object({
    key: z.string().min(1).max(256).optional(),
    name: z.string().min(1).max(256).optional(),
...
export const createHealthSummariesBodySchema = z
  .object({
...
export const updateHealthSummariesBodySchema = z
  .object({
...
export const createPlatformDiagnosticBodySchema = z
  .object({
    key: z.string().min(1).max(256),
    name: z.string().min(1).max(256),
    status: observeHealthStatusSchema,
...
export const updatePlatformDiagnosticBodySchema = z
  .object({
    key: z.string().min(1).max(256).optional(),
    name: z.string().min(1).max(256).optional(),
    status: observeHealthStatusSchema.optional(),

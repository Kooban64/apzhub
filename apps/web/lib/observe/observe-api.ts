...
import { createHttpObserveClient, type ObserveClient } from "./observe-client";
...
export function listLivenessChecks(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
...
export function updateLivenessCheck(
  id: string,
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
...
export function listComponentStatus(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
...
export function updateMetricSample(
  id: string,
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
...
export function listAlertDefinitions(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
...
export function listAlertStates(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
...
export function updateDashboardDefinition(
  id: string,
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
...
export function listTraceDefinitions(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
...
export function createTraceDefinition(
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
  return getObserveClient().traceDefinitions.create(input, options);
}
export function updateTraceDefinition(
  id: string,
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
...
export function listTraceSpans(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
...
export function updateTraceSpan(
  id: string,
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
...
export function listIncidentReferences(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
  return getObserveClient().incidentReferences.list(query, options);
}
export function getIncidentReference(
  id: string,
  options?: ObserveClientRequestOptions,
) {
...
export function updateIncidentReference(
  id: string,
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
...
export function listHealthSummaries(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
...
export function listObservabilityMetadata(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
  return getObserveClient().metadata.list(query, options);
}
export function getObservabilityMetadata(
  id: string,
  options?: ObserveClientRequestOptions,
) {
  return getObserveClient().metadata.get(id, options);
}
export function createObservabilityMetadata(
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
  return getObserveClient().metadata.create(input, options);
}
export function updateObservabilityMetadata(
  id: string,
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {
...
export function listPlatformDiagnostics(
  query?: ListQuery,
  options?: ObserveClientRequestOptions,
) {
  return getObserveClient().diagnostics.list(query, options);
}
export function getPlatformDiagnostic(
  id: string,
  options?: ObserveClientRequestOptions,
) {
...
export function updatePlatformDiagnostic(
  id: string,
  input: Record<string, unknown>,
  options?: ObserveClientRequestOptions,
) {

...
| *(APZHUB native)* | Quality Engineering | `QualityEngineeringService` | Native engine | `quality-engineering` | 5 | **Native** |
...
| Grafana | Observability UI | `ObservabilityService` | `GrafanaAdapter` | *(admin)* | 8 | OSS |
| Prometheus | Metrics | `ObservabilityService` | `PrometheusAdapter` | *(admin)* | 8 | OSS |
| Loki | Logs | `ObservabilityService` | `LokiAdapter` | *(admin)* | 8 | OSS |
| Greenbone | Vulnerability Mgmt | `SecurityOpsService` | `GreenboneAdapter` | *(security admin)* | 9 | OSS |
| MobSF | Mobile Security | `SecurityOpsService` | `MobSFAdapter` | *(security admin)* | 9 | OSS |
| Faraday | Pen Test Mgmt | `SecurityOpsService` | `FaradayAdapter` | *(security admin)* | 9 | OSS |

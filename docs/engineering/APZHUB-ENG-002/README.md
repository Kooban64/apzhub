...
| [PHASE-1A-CERTIFICATION.md](./PHASE-1A-CERTIFICATION.md)                                  | FINAL CERTIFIED           |
| [PORTFOLIO-ENGINEERING-CHARTER.md](./PORTFOLIO-ENGINEERING-CHARTER.md)                    | Charter §§12–14           |
...
Baseline 1.x: STABLE
Era 1: COMPLETE
ES-004+: enhancements (Dual Approval still required)

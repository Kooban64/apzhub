...
**Programme / Document:** OES-000  
**Title:** Owner Engineering Specification Standard  
**Date:** 2026-07-26  
**Evidence:** `docs/operations/evidence/portfolio-recert/20260726T233500Z-OES-000-ACCEPTANCE.json`
...
OES-000 is accepted as the permanent APZOR engineering methodology standard. It is based on proven delivery across APZHUB Foundation, Integration SDK, Search Integration, Verification, and Test Specifications (Architecture, Domain, Infrastructure).

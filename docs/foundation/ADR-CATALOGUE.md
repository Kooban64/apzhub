...
> **Current status:** Active — cross-reference index
...
| 0058 | [026](../026-integration-sdk-adapter-framework-integration-manifest-specification.md), [SDK-V1-CERTIFICATION](../../packages/integration-sdk/docs/SDK-V1-CERTIFICATION.md) | `@apzhub/integration-sdk` **0.9.0** (await owner 1.0.0) |

...
> **Current status:** **APZQEP flagship** — V1.0 **GA** · Waves 1–3 **CERTIFIED** · **APZQEP-164 ENGINEERING COMPLETE** (`platform-dashboard` + `platform-visualization` + `qep-dashboards`) · await **PBR-APZQEP-164** · Live: `https://apzhub.apzportal.apzor.com` · Law **PAUSED** · [PRODUCT-STATUS](../products/apzqep/PRODUCT-STATUS.md) · [apzqep-164/](../products/apzqep/v1.1/apzqep-164/).

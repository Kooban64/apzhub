...
> **Current status:** **APZQEP flagship** — V1.0 **GA** · Waves 1–4 **CERTIFIED** · Wave 5 architecture **APPROVED** · **APZQEP-165-PLAN COMPLETE** (S01–S18) · V1.1 foundational architecture **CLOSED** · last V1.1 planning programme complete · **APZQEP-165 AUTHORISED TO OPEN** (eng NOT STARTED; next Owner Auth **APZQEP-165-S01**) · Live: `https://apzhub.apzportal.apzor.com` · Law **PAUSED** · [PRODUCT-STATUS](../products/apzqep/PRODUCT-STATUS.md) · [apzqep-165-plan/](../products/apzqep/v1.1/apzqep-165-plan/).
...
**APZQEP-120 — Platform Foundation — CERTIFIED / PROGRAMME COMPLETE / CLOSED**

- Board: [APZQEP-120-PRODUCT-BOARD-CERTIFICATION.md](../products/apzqep/v1.1/apzqep-120/APZQEP-120-PRODUCT-BOARD-CERTIFICATION.md)
- Close-out: [APZQEP-120-PLATFORM-FOUNDATION-COMPLETE.md](../products/apzqep/v1.1/apzqep-120/APZQEP-120-PLATFORM-FOUNDATION-COMPLETE.md)
...
**APZQEP-150 — CERTIFIED / COMPLETE / STOPPED**

- Board: [APZQEP-150-PRODUCT-BOARD-CERTIFICATION.md](../products/apzqep/v1.1/apzqep-150/APZQEP-150-PRODUCT-BOARD-CERTIFICATION.md) — programme **PASSED**; production **NO-GO**
...
- Owner Ratification: [APZQEP-CONSTITUTION-OWNER-RATIFICATION.md](../products/apzqep/APZQEP-CONSTITUTION-OWNER-RATIFICATION.md) — **RATIFIED / APPROVED / BASELINED** (2026-07-28)
...
- Owner entry: [OWNER-ACCEPTANCE.md](../products/apzqep/portfolio/PORTFOLIO-001/OWNER-ACCEPTANCE.md)
...
- Status: **FROZEN / APPROVED / CLOSED**
- Evidence: `20260728T092059Z-APZQEP-TEST-PLANS-1.0.0-FREEZE.json`
- Package: `@apzhub/qep-test-plans` **1.0.0 CERTIFIED / FROZEN** (promoted under CERT-080A; Freeze does not change the version — it locks it as the production baseline)

**Stop condition:** No further Test Plans work is authorised under existing identifiers (`APZQEP-CERT-080A`, `APZQEP-FREEZE-080A`, or any consumed upstream identifier). Future work requires a new, separate Owner-authorised programme.

**Owner entry:** [freeze/README.md](../products/apzqep/test-plans/freeze/README.md) · [freeze/OWNER-FREEZE-DECISION.md](../products/apzqep/test-plans/freeze/OWNER-FREEZE-DECISION.md) — **FROZEN / APPROVED / CLOSED**
...
1. No further Test Plans work is authorised under existing identifiers.
2. Test Plans **1.0.0** is now the frozen production baseline, joining Requirements, Traceability, Verification, and Test Specifications — all **1.0.0 FROZEN**.
3. Any future capability work requires a new, Owner-authorised programme identifier; do not invent one.
4. **APZQEP-PORTFOLIO-001 — Foundation Completion & Portfolio Baseline** is **ACCEPTED / APPROVED / CLOSED** — [pack](../products/apzqep/portfolio/PORTFOLIO-001/README.md). **APZQEP Foundation is formally complete; Capability Expansion is READY.** It does **not** authorise any Wave 2 capability (Test Execution, Test Runs, Test Suites, Evidence, Defects, Coverage & Analytics, Reporting, AI-Assisted Testing) — each requires its own future, separate Owner-authorised Architecture programme. **Authorised next delivery: none** under existing identifiers.
5. **APZQEP-CONSTITUTION v1.0.0 — RATIFIED / APPROVED / BASELINED** (2026-07-28) — [APZQEP-CONSTITUTION.md](../products/apzqep/APZQEP-CONSTITUTION.md) is now the constitutional entry point for APZQEP. **APZQEP FOUNDATION FULLY COMPLETE. ENGINEERING PLATFORM V1. CAPABILITY EXPANSION READY. NO WAVE-2 PROGRAMMES AUTHORISED.** Authorised next delivery: **None.** Wave 2 requires a separate Owner-authorised Architecture programme; do not invent one.
...
- Evidence (implementation): `20260728T094331Z-APZQEP-PORTFOLIO-001.json`
- Evidence (acceptance): `20260728T100955Z-APZQEP-PORTFOLIO-001-ACCEPTANCE.json`
- Owner entry: [portfolio/PORTFOLIO-001/OWNER-SUMMARY.md](../products/apzqep/portfolio/PORTFOLIO-001/OWNER-SUMMARY.md) · [portfolio/PORTFOLIO-001/OWNER-ACCEPTANCE.md](../products/apzqep/portfolio/PORTFOLIO-001/OWNER-ACCEPTANCE.md) — **ACCEPTED / APPROVED / CLOSED**
- Declaration: **APZQEP FOUNDATION IS FORMALLY COMPLETE** — [FOUNDATION-COMPLETION-STATEMENT.md](../products/apzqep/portfolio/PORTFOLIO-001/FOUNDATION-COMPLETION-STATEMENT.md) — **EFFECTIVE**

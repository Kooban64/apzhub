...
| `@apzhub/platform-services`          | Platform service implementations + gateway — **0.25.0** (Metrics + Observability + Identity + Administration + Configuration + Notification + Workflow + Search + Documents); Metrics **APZMETRICS-002** |

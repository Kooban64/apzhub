...
Decision support without exposing Metabase (or other) branding.
...
- Users interact with **APZ Analytics** through APZHUB Workbench and Platform APIs only
...
**Concept** — see [IMPLEMENTATION-READINESS.md](./IMPLEMENTATION-READINESS.md) and [APZHUB-PRODUCT-PORTFOLIO](../APZHUB-PRODUCT-PORTFOLIO.md).

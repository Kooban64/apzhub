...
| G-19 | Permissions UI              | Manifest permissions; no dedicated session permission audit in this slice                 | Session / PermissionService only                                     | Defer deep identity proof to N-02                      | Native            | No           | —        | N-02    |
| G-20 | Identity / session          | Platform routes under Better Auth / gateway (assumed; not UX-proven here)                 | One APZHUB identity end-to-end                                       | N-02 scope                                             | Native            | No           | —        | N-02    |

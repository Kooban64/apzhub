...
| ---- | --------------------------- | --------------------------------------------------------------------------------- | --------------------------------------- | --------------------------------------- | ----------------- | ------------ | ------------ | ----- |
| G-01 | Branding / product name     | Chrome / titles use **Support**; manifest view title Support                      | Consistent **APZ Support**              | Product identity not elevated           | Requires Redesign | No           | High         | N-03  |
...
| G-07 | Raw technical IDs           | Detail shows raw requester/assignee/group/org IDs                                 | Human labels (Time N-03 pattern)        | Wrapper feel                            | Wrapper           | No           | High         | N-03  |
| G-08 | Create / domain jargon      | Copy references “Support-domain” IDs                                              | Product language only                   | Integration vocabulary                  | Wrapper           | No           | Medium       | N-03  |
...
| G-11 | Layout / page structure     | Local `PageShell` only — no breadcrumbs / workspace frame                         | Align with Time workspace composition   | Thin                                    | Requires Redesign | No           | High         | N-03  |
| G-12 | Menus / actions             | Commands on detail; no context panel                                              | Context panel + quick actions           | Sparse                                  | Requires Redesign | No           | Medium       | N-03  |
| G-13 | Empty states                | Basic empty; inbox empty weak CTA                                                 | APZ Support empties + CTAs              | Thin                                    | Wrapper           | No           | Medium       | N-03  |
| G-14 | Errors (UX)                 | ErrorState + Retry                                                                | Align naming with APZ Support           | Adequate                                | Native            | No           | Low          | N-03  |
| G-15 | Loading                     | “Loading Support…”                                                                | “Loading APZ Support…”                  | Naming                                  | Native            | No           | Low          | N-03  |
| G-16 | Onboarding                  | Absent                                                                            | First-run guidance                      | Missing                                 | Requires Redesign | No           | Medium       | N-03  |
| G-17 | Settings                    | Absent                                                                            | APZHUB Support preferences only         | Missing                                 | Requires Redesign | No           | Medium       | N-03  |
...
| G-20 | Permissions UI              | Hardcoded `DEFAULT_UI_PERMISSIONS = ["support.*"]`                                | Session / PermissionService only        | Same class of defect Time closed in A02 | Requires Redesign | No           | **Critical** | N-02  |
| G-21 | Identity / session          | No session permission hook on router                                              | One APZHUB identity end-to-end          | Critical                                | Requires Redesign | No           | **Critical** | N-02  |
| G-22 | Breadcrumbs                 | None                                                                              | APZ Support → section → entity          | Missing                                 | Requires Redesign | No           | High         | N-03  |
| G-23 | Context panel               | None                                                                              | Selection/actions context               | Missing                                 | Requires Redesign | No           | Medium       | N-03  |
| G-24 | Design system               | `@apzhub/ui` + local primitives                                                   | Shared workspace patterns               | Acceptable foundation                   | Native            | No           | Low          | N-03  |
| G-25 | Permission undefined bypass | Detail soft-opens when permissions undefined                                      | Undefined = deny                        | Soft-open risk                          | Requires Redesign | No           | High         | N-02  |
| G-26 | Permission coverage gaps    | Users/search/analytics ignore permission props; create ungated                    | Gate all sensitive surfaces             | Incomplete                              | Wrapper           | No           | High         | N-02  |
| G-27 | Realtime chrome             | Protocol jargon possible in status copy                                           | Product-safe live-update language       | Minor                                   | Native            | No           | Low          | N-03  |
| G-28 | Manifest branding           | `engineBranding: hidden`; activity label Support                                  | Keep hidden; chrome = APZ Support       | Hidden flag good                        | Already Compliant | No           | —            | N-03  |

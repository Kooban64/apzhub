# Operating Model — APZ-SUPPORT-NATIVE-001-N04
...
Every APZ Support engineering change is managed through APZQEP. There is no parallel quality path and no engine-native release path for APZHUB Support work.
...
| Layer              | Owner                       | Notes                      |
| ------------------ | --------------------------- | -------------------------- |
| Product experience | APZ Support / APZHUB        | Native after N-01…N-03     |
| Business services  | Support platform services   | Unchanged by N-04          |
| Integration        | Support adapter (invisible) | Implementation detail only |
...
- Opening APZQEP-170 from a single Support friction event

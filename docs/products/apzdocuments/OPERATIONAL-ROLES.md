# APZ Documents — Operational Roles
...
| **QA**                  | Validate quality gates; leakage/regression; work-companion framing; complete Quality checklist                  | Flow; build; Engineering checklist | Quality checklist; defects         |
...
| **Operations**          | Production care; operational review                                                                             | Health signals; release packs      | Ops confirmation; incidents        |
...
| ------------------------------------------ | ---------------------------------- |
| Scope creep / consumer wiring outside Auth | Product Owner → Product Board      |
| Quality Flow blocked                       | Engineering Manager                |
| Suspected architecture change needed       | Product Board (do not implement)   |
| Engine/provider leakage in UX              | QA + Product Owner (block release) |

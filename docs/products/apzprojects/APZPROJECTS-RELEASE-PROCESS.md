...
Define how APZ Projects ships under APZQEP. This is operational process — not feature work.

## Preconditions

- N-01…N-03 remain unchanged (native experience baseline)
- Change is within Owner-authorised scope
- Architecture remains frozen (APZQEP V1.1; Projects product contract unchanged)
...
| Situation                                   | Label                                       |
| ------------------------------------------- | ------------------------------------------- |
| First real Projects change under this model | Next free APZQEP release number             |

# APZ Projects — Operational Learning
...
For every **completed APZ Projects release**, capture Operational Learning.  
...
| Field                | Content                                         |
| -------------------- | ----------------------------------------------- |
| Engineering Friction | What slowed engineering under APZQEP / Projects |
...
| Artefact                                                                                   | Role                                 |
| ------------------------------------------------------------------------------------------ | ------------------------------------ |
| This face                                                                                  | APZ Projects-specific learning index |
| [ADOPT-001 Learning Register](../apzqep/apzqep-adopt-001/OPERATIONAL-LEARNING-REGISTER.md) | Cross-product durable insight        |
| [Emerging Portfolio Patterns](../framework/APZHUB-EMERGING-PORTFOLIO-PATTERNS.md)          | Cross-product pattern observations   |
...
| --- | ------- | ---- | -------------------------------------------- | ------ |
| —   | —       | —    | _(none yet — first real release under N-04)_ | —      |

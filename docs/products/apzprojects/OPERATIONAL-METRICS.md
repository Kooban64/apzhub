# APZ Projects — Operational Metrics
...
| --------------------------- | ------------------------------------------------------ | ------------------ |
| Quality Flows opened        | Count of Flows opened for APZ Projects changes         | Per Flow           |
...
| Operational learning count  | Learning Register entries for APZ Projects             | Per period         |

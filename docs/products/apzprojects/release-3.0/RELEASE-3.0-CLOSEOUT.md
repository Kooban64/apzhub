...
### 1.1 Workspace & Cockpit (W002 / W011 S-01, S-07–S-10, S-21–S-24)

| ID    | Description                                                                                                                                    | Status  | Dependency                      | Complexity | Acceptance criteria                                                         |
| ----- | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------------------------------- | ---------- | --------------------------------------------------------------------------- |
| PX-01 | Finish Operational Workspace fidelity: queue D4 ranking, exclusive user-scoped membership, show-more, keyboard j/k · 1/2/3, metric-band drills | Partial | Ops APIs; P1 for live Approvals | L          | Matches W002 §5–7; strips show Health+Confidence; empty groups = None       |
...
| PX-06 | Close Project Wizard (S-10) with closure gates + Workflow outcomes                                                                             | Partial | Lifecycle + P1                  | M          | Cannot close when gates fail; approvals via Workflow when required          |
...
| PX-09 | Mobile Queue Shell (S-21)                                                                                                                      | None    | PX-01                           | L          | Queue-first IA; no strips/admin as primary; action sheet on row             |
| PX-10 | Universal Object Surface (S-08)                                                                                                                | None    | Cockpit chrome                  | L          | Same chrome for commitment/wait/decision/risk/exception/milestone           |
...
| PX-12 | Preferences: density · collapsed queue groups · default portfolio sort                                                                         | None    | Preferences service             | M          | Persist per user; restore on load                                           |

### 1.2 Portfolio (W005 / S-02–S-06)

| ID    | Description                                                                          | Status  | Dependency                    | Complexity | Acceptance criteria                                             |
| ----- | ------------------------------------------------------------------------------------ | ------- | ----------------------------- | ---------- | --------------------------------------------------------------- |
| PX-20 | Portfolio Scorecard (S-02) — executive default, not KPI card grid                    | None    | Portfolio projection API      | L          | Drills to workspace/cockpit; UI-D7                              |
| PX-21 | Portfolio Workspace (S-03) — Overview · Queue · hierarchy strips · Changes · Context | Partial | Roll-up API exists            | L          | Same grammar as S-01 scoped to portfolio                        |
| PX-22 | Portfolio Timeline (S-04)                                                            | None    | PX-05 patterns                | L          | Cross-project milestone/commitment windows                      |
...
| ID    | Description                                                       | Status | Dependency                  | Complexity | Acceptance criteria                                                |
| ----- | ----------------------------------------------------------------- | ------ | --------------------------- | ---------- | ------------------------------------------------------------------ |
| PX-40 | Continuity Case / meeting outcome overlays (O-09 · O-10)          | None   | Collaboration service stubs | L          | Outcomes attach to operational objects; no module notify subsystem |
| PX-41 | Mentions / watch / activity via platform Attention (compose only) | None   | Notification Framework      | M          | Projects publishes events; Attention delivers                      |
| PX-42 | Announcement / Notice editors (O-17) where W007 requires          | None   | Admin perms                 | M          | Permission-gated; audited                                          |
| PX-43 | Object Discussion panel + unread indicators                       | None   | Collaboration + Attention   | L          | Discussion on operational objects; unread visible                  |
| PX-44 | Unified Communication Timeline on History/Object surfaces         | None   | PX-04 · PX-10               | L          | Timeline composes operational + communication events               |
| PX-45 | Control: Stakeholders · Responsibility Matrix · Escalation path   | None   | Identity P2                 | L          | Control intent surfaces ownership/escalation per W006/W007         |

### 1.5 Reporting & Review (W008 / S-11–S-14)

| ID    | Description                                                | Status | Dependency               | Complexity | Acceptance criteria                                       |
| ----- | ---------------------------------------------------------- | ------ | ------------------------ | ---------- | --------------------------------------------------------- |
| PX-50 | Operational Review (S-11)                                  | None   | Review pack model        | L          | Summary · pack · outcomes · complete → read-only snapshot |
| PX-51 | Review Calendar (S-12)                                     | None   | PX-50                    | M          | Schedule + open past/future reviews                       |
| PX-52 | Reports Library + Viewer (S-13 · S-14) with How calculated | None   | Reporting catalogue W008 | L          | Export PDF/CSV; explainability; drill to cockpit          |

### 1.6 Productivity & Search (W009 / S-20 · O-01–O-03 · O-11)

| ID    | Description                                        | Status  | Dependency           | Complexity | Acceptance criteria                           |
| ----- | -------------------------------------------------- | ------- | -------------------- | ---------- | --------------------------------------------- |
| PX-60 | Search Results (S-20) with facets + explainability | Partial | Search exists thinly | M          | Facets; open in context; permission-filtered  |
| PX-61 | Command Palette Projects commands (O-01)           | Partial | Platform UCP         | M          | Actions · Go to · Create; permission-filtered |
| PX-62 | Shortcut Help (O-03) + W009 shortcut catalogue     | None    | —                    | S          | `?` shows Projects shortcuts                  |
| PX-63 | Productivity Session picker (O-11)                 | None    | Session prefs        | M          | Start/resume scoped sessions                  |

### 1.7 Administration (W010 / S-17–S-19)

| ID    | Description                                                              | Status  | Dependency      | Complexity | Acceptance criteria                                                  |
| ----- | ------------------------------------------------------------------------ | ------- | --------------- | ---------- | -------------------------------------------------------------------- |
| PX-70 | Admin Dashboard (S-17) — Administration labels, not Scorecard            | None    | Admin APIs · P3 | L          | MetricBand + W010 panels; permission-gated                           |
| PX-71 | Admin Registries (S-18) — Profiles · Policies · Roles · Templates · etc. | None    | P3              | XL         | DataTables + editor drawers; publish via simulation                  |
...
| ID    | Description                                                                                                                                                    | Status      | Dependency                      | Complexity | Acceptance criteria                                                                                                                         |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------- | ------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| PR-01 | **P1 Workflow Bridge complete** — Postgres binding store · HTTP request/list/apply/sync · production executor · queue Approval rows · cert-env waiver lockdown | In progress | Workflow platform               | L          | Hold · Closure · Governance · Checkpoint · Exception execute in Workflow; Projects consumes outcomes only; bindings not memory-only in prod |
| PR-02 | **P2 Enterprise Identity Pickers** — User · Team · Role validation everywhere ownership is set                                                                 | Not started | Identity / BetterAuth directory | L          | No free-text owner fields in Projects UI; invalid principals rejected                                                                       |
| PR-03 | **P3 Organisation Governance Administration** — enterprise Governance Profile CRUD + publish                                                                   | Not started | PX-70/71 · platform PG          | L          | Org profiles versioned; snapshotted on project; audited publish                                                                             |
| PR-04 | **P4 Migration Verification** — apply/verify `0109`–`0114` (+ any closeout migrations) on all supported envs                                                   | Not started | Ops access                      | M          | Documented verify script; clean up/down; no data loss                                                                                       |

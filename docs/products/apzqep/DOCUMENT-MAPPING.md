...
| APZQEP-120 S07 Domain Event Catalogue                | `docs/products/apzqep/v1.1/apzqep-120/S07-COMPLETION.md`                     | **COMPLETE / PASS**                                                 |
| APZQEP Evidence Event Catalogue                      | `docs/products/apzqep/events/EVENT-CATALOGUE.md`                             | **ACTIVE** v1.0.0                                                   |
| APZQEP-120 next programme                            | S08 TE outbox drain                                                          | Requires Owner instruction                                          | `docs/products/apzqep/v1.1/apzqep-120/PRODUCT-BOARD-RECOMMENDATION-NEXT-PROGRAMME.md` | **S07** recommended · implementation NONE |

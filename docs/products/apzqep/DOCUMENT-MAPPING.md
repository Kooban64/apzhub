...
| APZQEP Engineering Framework v1.0              | `docs/products/apzqep/engineering/APZQEP-ENGINEERING-FRAMEWORK.md`           | **BASELINED** · **MAINTENANCE** — core product (Constitution, Handbook, Standards, Spec Template) |
| APZQEP-ENG-001 programme                       | `docs/products/apzqep/engineering/`                                          | **COMPLETE** — Framework v1.0 BASELINED · MAINTENANCE; handover to APZHUB-ENG-002                 |
...
| APZHUB-ENG-002 Portfolio Engineering Standards | `docs/engineering/APZHUB-ENG-002/`                                           | **DESIGNED** — matrix ACCEPTED; execution deferred to next session                                |

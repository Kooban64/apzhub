...
> **Standing Programme Record:** **IN FORCE** (2026-07-28) — [STANDING-PROGRAMME-RECORD.md](./STANDING-PROGRAMME-RECORD.md) — **official standing state** of APZQEP (permanent baseline for future conversations)  
...
> **APZQEP-RELEASE-001** — Production Release — **IMPLEMENTED / AWAITING OWNER RELEASE DECISION** — [RELEASE-001](./test-execution/RELEASE-001/README.md) · **LIMITED_AVAILABILITY_APPROVED** (recommended)  
> Unrestricted GA **NOT AUTHORISED** (L-02) · Authorised next delivery: **Owner Production Release Decision only**
...
| **RELEASE-001 Test Execution (awaiting Owner Release decision)**             | [test-execution/RELEASE-001/OWNER-SUMMARY.md](./test-execution/RELEASE-001/OWNER-SUMMARY.md)                     |

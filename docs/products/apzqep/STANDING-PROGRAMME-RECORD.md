...
| RELEASE-004    | [evidence-management/RELEASE-004/](./evidence-management/RELEASE-004/README.md) **CLOSED / COMPLETE** · **1.0.0** · `{tag}` |

### Default premise

- Production baseline: `@apzhub/qep-evidence` **1.0.0** @ `{promotion}` (from FREEZE-004 RC @ `4e1b6f01`).
...
FREEZE-004 = CLOSED
RELEASE-004 = CLOSED / COMPLETE (1.0.0)

...
| Identity             | _(platform)_                    | Platform             | —                                            | Better Auth                    |
...
| Notification         | _(platform)_                    | Platform             | —                                            | All events                     |
...
| **Owned information**    | QualityIndicator, Insight, ScoreExplanation _(derived)_                             |
...
| **Owned information**    | AISession, AIRecommendation, PromptTemplate _(non-SoR until accepted)_                                    |
...
| **Owned information**    | _(Platform SoR)_                                            |
| **Consumed information** | Better Auth                                                 |
| **Published events**     | _(Platform)_                                                |
...
| **Owned information**    | InvestigationView, LegalHold _(refs)_                                               |
...
| **Owned information**    | SavedSearch, NavigationPin _(user prefs adjunct)_                                    |
...
| **Owned information**    | ReportDefinition, ExportJob _(derived)_                                         |
...
| **Responsibilities**     | _(Platform Attention Engine)_ — modules publish, never direct delivery |
| **Owned information**    | _(Platform)_                                                           |

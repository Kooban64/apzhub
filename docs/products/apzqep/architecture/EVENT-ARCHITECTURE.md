...
**Constitutional constraint:** No event subscriber may **auto-approve** or **auto-flip** certification status. Continuous signals may publish *re-certification requested* — humans decide.

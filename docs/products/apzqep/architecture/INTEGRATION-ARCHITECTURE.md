...
A proposed integration is **in-boundary** when it improves the answer to _Can this software be released with sufficient confidence?_ through governed quality information. It is **out-of-boundary** when it primarily manages work items, pipelines, code hosting, or unrestricted agent automation without QE SoR purpose.

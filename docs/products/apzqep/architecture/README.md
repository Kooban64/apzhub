...
| --- | --------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1  | **Verification-first**            | _Verification_ is the primary product concept; classical test cases are one procedure form. Architecture centres on verification lifecycle, not runner or ALM metaphors.                                                         |
...
| Document                        | Path                                                       |
| ------------------------------- | ---------------------------------------------------------- |
| Owner Acceptance (Architecture) | OWNER-ACCEPTANCE.md _(to be added on Acceptance workflow)_ |
| Completion Report               | COMPLETION-REPORT.md _(to be added on programme close)_    |

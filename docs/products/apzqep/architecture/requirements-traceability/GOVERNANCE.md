# Governance — APZQEP-ARCH-007

> Companion extract. Authoritative detail: [TRACEABILITY-ARCHITECTURE.md](./TRACEABILITY-ARCHITECTURE.md) §7.
...
Orphan Requirements · Broken Traces · Missing Traces · Circular Traces (per-type policy) · Duplicate Traces.

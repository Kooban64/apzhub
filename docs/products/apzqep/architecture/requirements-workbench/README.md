# APZQEP-ARCH-006 — Requirements Workbench Architecture
...
> **Rule:** Future Workbench engineering shall conform; ENG-020F Part 3 implements the authorised slice

## Purpose

Authoritative interaction architecture for the APZ QEP Requirements Workbench and the reusable Workbench operating model for Traceability, Verification, Specifications, Test Cases, Execution, Evidence, and Certification.
...
ARCH-006 is **ACCEPTED**. Workbench grammar is authoritative for Traceability UI. Traceability Workbench specialisation **APZQEP-ARCH-008** is **ACCEPTED**; UI under **APZQEP-ENG-030C** ([workbench](../../traceability/workbench/README.md)) — **IMPLEMENTED / AWAITING OWNER ACCEPTANCE**.

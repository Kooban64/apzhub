...
The roadmap answers: *in what order shall QEP be built so that each increment is releasable, architecture-compliant, and moves the product toward certifiable manual MVP and GA?*
...
*Durations are planning estimates for sequencing — not committed delivery dates. Actual programme authorisation sets sprint calendars.*

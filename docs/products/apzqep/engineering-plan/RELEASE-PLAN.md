...
_Programme IDs are indicative placeholders until Owner names authoritative ENG programmes._
...
| Module              | Touch type                      |
| ------------------- | ------------------------------- |
| _(none functional)_ | Manifest stubs only for M01–M22 |

### Services touched

| Service             | Touch type                           |
| ------------------- | ------------------------------------ |
| _(none functional)_ | `service.yaml` stubs for AS-01–AS-22 |

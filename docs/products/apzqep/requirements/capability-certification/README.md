...
> **Rule:** Requirements engineering frozen; next authorised work is Traceability Architecture (ARCH-007)

## Purpose

Certify, baseline, and freeze the complete APZ QEP Requirements capability as the authoritative Requirements module after acceptance of ENG-020A–020F and ARCH-005/006.
...
[docs/releases/apzqep/requirements/1.0.0/](../../../../releases/apzqep/requirements/1.0.0/README.md)
...
Requirements Capability **1.0.0** is **ACCEPTED / CERTIFIED / FROZEN**. Do **not** begin Requirements engineering. Traceability architecture: [APZQEP-ARCH-007](../../architecture/requirements-traceability/README.md).

...
> **Acceptance:** **ACCEPTED** — [OWNER-ACCEPTANCE.md](./OWNER-ACCEPTANCE.md)
...
**APZQEP-OES-ENG-070A** — Test Plans Workbench Engineering Specification — **IMPLEMENTED / AWAITING OWNER ACCEPTANCE** — [canonical pack](../OES-ENG-070A/README.md).

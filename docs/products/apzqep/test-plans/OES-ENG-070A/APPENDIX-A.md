...
| Term                          | Definition                                                                                                                                                             |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **ENG-070A** _(future)_       | Anticipated Workbench Engineering implementation programme — requires a separate Owner Instruction after this OES is Accepted                                          |
...
| **Binding invariant**         | _"The Workbench SHALL never determine what a user may do"_ — Owner directive recorded at ARCH-014 Acceptance                                                           |

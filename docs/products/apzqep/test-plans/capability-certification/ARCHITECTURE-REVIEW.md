...
This chain constitutes the binding architectural invariant reaffirmed at ARCH-014 Owner Acceptance: *"The Workbench SHALL never determine what a user may do."* It is confirmed intact end-to-end by this Capability Certification.

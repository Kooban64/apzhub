...
| Next programme        | **V1.1 FEATURE COMPLETE · ARCHITECTURE FROZEN** · [Architecture Freeze](./apzqep-version-1.1-architecture-freeze/) · [QO-018](./apzqep-165-qo-018/) · adoption + provider programmes only · [WAVE-PROGRESS-REGISTER](./WAVE-PROGRESS-REGISTER.md) |

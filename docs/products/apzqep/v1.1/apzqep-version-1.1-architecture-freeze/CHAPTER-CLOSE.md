# Chapter Close — APZQEP Version 1.1
...
| Then                    | Now                           |
| ----------------------- | ----------------------------- |
| How should APZQEP work? | **What did APZQEP teach us?** |

The platform is no longer the subject. It has become the **instrument**.

## Forever principle (every future programme)
...
Day-to-day experience determines whether developers embrace APZQEP — not only major releases.

After Release 0001, ask about hesitation, artefacts opened, meaningful vs redundant steps,
surprises, what got easier, what got harder — not pass counts alone.

## Standing commitments

- Version 1.1 baseline remains frozen.

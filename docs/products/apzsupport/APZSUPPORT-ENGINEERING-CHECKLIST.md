# APZ Support — Engineering Checklist
...
[ ] No adapter enhancements unless separately authorised

Implementation
[ ] Product contract remains APZ Support (no engine branding)
[ ] Identity remains APZHUB-only (no second login)

# APZ Support — Operational Readiness
...
| ------------------------------------- | --------------------------- | ----------------------------------- |
| Use APZ Support as product            | All users                   | Single APZHUB identity              |
...
| Check      | Question                                            |
| ---------- | --------------------------------------------------- |
| Open Flows | Any APZ Support Quality Flow stalled?               |
...
Observation ≠ authorisation to change APZQEP or Support features.

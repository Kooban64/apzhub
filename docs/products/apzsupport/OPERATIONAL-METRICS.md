# APZ Support — Operational Metrics
...
| --------------------------- | ------------------------------------------------------ | ------------------ |
| Quality Flows opened        | Count of Flows opened for APZ Support changes          | Per Flow           |
...
| Operational learning count  | Learning Register entries for APZ Support              | Per period         |

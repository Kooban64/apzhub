...
Follow [PRODUCT-BACKLOG-STANDARD](../PRODUCT-BACKLOG-STANDARD.md).

## Current backlog themes (no invented IDs)

- Product packaging
- Consumer wiring for other products (explicitly out of certified non-goals until authorised)
- No invented story IDs

## Rule

Do **not** invent programme or story IDs. Items become actionable only under Owner-approved programmes.

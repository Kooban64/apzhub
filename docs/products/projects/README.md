...
> **Current Production Release:** **1.1.0** — **ACCEPTED / CLOSED** · [evidence](../../releases/projects/1.1.0/README.md)  
> **Phase 1 programme:** [APZHUB-PROJECTS-001](../../sprint/APZHUB-PROJECTS-001-sprint-guide.md) — **ACCEPTED / CLOSED**  
> **Maturity:** **Production** (with documented limitations)  
> **Releases:** [RELEASES.md](./RELEASES.md)  
> **Reference pattern:** [Product Engineering Reference Implementation](../APZHUB-PRODUCT-ENGINEERING-REFERENCE-IMPLEMENTATION.md)  
...
| [RELEASES.md](./RELEASES.md)                                 | Version history · current **1.1.0** |

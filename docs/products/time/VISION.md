...
Revenue recognition, utilisation, Law billing adjacency, project cost signals.
...
- Users interact with **APZ Time** through APZHUB Workbench and Platform APIs only
...
**Planning** — see [IMPLEMENTATION-READINESS.md](./IMPLEMENTATION-READINESS.md) and [APZHUB-PRODUCT-PORTFOLIO](../APZHUB-PRODUCT-PORTFOLIO.md).

# APZ QEP Requirements Capability — 1.0.0 Permanent Release Evidence

> **Product capability:** APZ QEP Requirements Module  
> **Package:** `@apzhub/qep-requirements` **1.0.0**  
> **Programme:** APZQEP-REQ-001 — Requirements Capability Certification & Baseline  
> **Status:** **ACCEPTED / CLOSED / COMPLETE** (APZQEP-REQ-001)  
> **Certification class:** **PRODUCTION_READY_WITH_LIMITATIONS**  
> **Recommendation:** **PRODUCTION READY**  
> **Freeze:** Requirements Capability **CERTIFIED / FROZEN** — no further Requirements engineering
...
Requirements **1.0.0** is accepted and frozen. Traceability architecture: [APZQEP-ARCH-007](../../../products/apzqep/architecture/requirements-traceability/README.md) — awaiting Owner Acceptance. Do not begin Traceability engineering.

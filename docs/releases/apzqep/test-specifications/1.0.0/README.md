# APZ QEP Test Specifications Capability — 1.0.0 Permanent Release Evidence

> **Product capability:** APZ QEP Test Specifications Module  
> **Package:** `@apzhub/qep-test-specifications` **1.0.0**  
> **Programme:** APZQEP-CERT-050D — Test Specifications Capability Certification  
> **Status:** **1.0.0 CERTIFIED / FROZEN** · **BASELINE ESTABLISHED**  
> **Certification class:** **PRODUCTION_READY_WITH_LIMITATIONS**  
> **Freeze:** [Owner Freeze Decision](../../../products/apzqep/test-specifications/freeze/OWNER-FREEZE-DECISION.md) · `20260727T095000Z-APZQEP-TEST-SPECIFICATIONS-1.0.0-FREEZE.json`
...
Baseline frozen. No uncontrolled changes. Future work requires a new Owner-authorised programme.

# APZ QEP Verification Capability — 1.0.0 Permanent Release Evidence

> **Product capability:** APZ QEP Verification Module  
> **Package:** `@apzhub/qep-verification` **1.0.0**  
> **Programme:** APZQEP-CERT-040D — Verification Capability Certification  
> **Status:** **ACCEPTED / CLOSED / COMPLETE** (APZQEP-CERT-040D)  
> **Certification class:** **PRODUCTION_READY_WITH_LIMITATIONS**  
> **Recommendation:** **PRODUCTION READY**  
> **Baseline:** Verification Capability **1.0.0 CERTIFIED / FROZEN**
...
Verification **1.0.0** is frozen. Do **not** begin Evidence, Coverage, Impact, Certification Engine, AI, or MCP without a separate Owner Instruction. Current architecture programme: [APZQEP-ARCH-011](../../../products/apzqep/architecture/test-specifications/README.md).

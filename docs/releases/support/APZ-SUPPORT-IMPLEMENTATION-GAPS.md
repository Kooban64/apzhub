...
| S2-02 | No Event Bus publish for Support operations                                                           | **High**     | **No**           | **Yes** if 2.0 claims event-driven ops                  | KNOWN-LIMITATIONS · SUPPORT cert                                         |
...
| S2-05 | No Support vertical notifications / realtime                                                          | **High**     | **No**           | **Yes** if 2.0 claims Attention Engine delivery         | KNOWN-LIMITATIONS                                                        |

...
| Proofs    | Support three-pane + requester · Global timer · Projects board/drawer · My Work tabs · Time approve · User Inspector · Preview drawer       |
...
| Gap                          | Action                                                                               |
| ---------------------------- | ------------------------------------------------------------------------------------ |
| Requester product role seed  | Slim `product-support-requester` role still optional — detection is permission-based |
...
- Requester detection depends on absence of agent permissions — seed requester grants carefully

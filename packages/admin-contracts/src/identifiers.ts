...
export type AdministrationPermissionId = Brand<string, "AdministrationPermissionId">;
...
export type AdministrationDiagnosticId = Brand<string, "AdministrationDiagnosticId">;
export type AdministrationRegistrationId = Brand<
  string,
  "AdministrationRegistrationId"
>;
export type AdministrationMetadataId = Brand<string, "AdministrationMetadataId">;
export type AdministrationPolicyId = Brand<string, "AdministrationPolicyId">;
export type AdministrationReferenceId = Brand<string, "AdministrationReferenceId">;
export type AdministrationCapabilityId = Brand<string, "AdministrationCapabilityId">;
export type AdministrationNavigationId = Brand<string, "AdministrationNavigationId">;
export type AdministrationShortcutId = Brand<string, "AdministrationShortcutId">;
export type AdministrationDashboardId = Brand<string, "AdministrationDashboardId">;
...
export function asAdministrationCategoryId(value: string): AdministrationCategoryId {
  return brandId(value);
}
export function asAdministrationSectionId(value: string): AdministrationSectionId {
  return brandId(value);
}
...
export function asAdministrationHistoryId(value: string): AdministrationHistoryId {
  return brandId(value);
}
...
export function asAdministrationMetadataId(value: string): AdministrationMetadataId {
  return brandId(value);
}
export function asAdministrationPolicyId(value: string): AdministrationPolicyId {
  return brandId(value);
}
export function asAdministrationReferenceId(value: string): AdministrationReferenceId {
  return brandId(value);
}
...
export function asAdministrationShortcutId(value: string): AdministrationShortcutId {
  return brandId(value);
}
export function asAdministrationDashboardId(value: string): AdministrationDashboardId {
  return brandId(value);
}

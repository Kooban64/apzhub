...
export const platformConfigurationGroup = pgTable("platform_configuration_group", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull(),
  organisationId: text("organisation_id"),
...
export const platformConfigurationKey = pgTable("platform_configuration_key", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull(),
  organisationId: text("organisation_id"),
  namespaceId: text("namespace_id").notNull(),
...
export const platformConfigurationValue = pgTable("platform_configuration_value", {
  id: text("id").primaryKey(),
...
export const platformConfigurationVersion = pgTable("platform_configuration_version", {
  id: text("id").primaryKey(),
  configurationId: text("configuration_id").notNull(),
...
export const platformConfigurationHistory = pgTable("platform_configuration_history", {
  id: text("id").primaryKey(),
  configurationId: text("configuration_id").notNull(),
  versionId: text("version_id"),
...
export const platformConfigurationAudit = pgTable("platform_configuration_audit", {
  id: text("id").primaryKey(),
  tenantId: text("tenant_id").notNull(),

...
export const platformIamPermissionAssignment = pgTable("platform_iam_permission_assignment", {
    id: text("id").primaryKey(),
    tenantId: text("tenant_id").notNull(),
...
export const platformIamOrganization = pgTable(
  ...
  (table) => [
    uniqueIndex("platform_iam_organization_tenant_key_uidx").on(table.tenantId, table.key),
  ],
);
...
export const platformIamDepartment = pgTable(
  ...
  (table) => [
    uniqueIndex("platform_iam_department_tenant_key_uidx").on(table.tenantId, table.key),
  ],
);

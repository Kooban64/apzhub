...
export type ConfigurationValidationId = Brand<string, "ConfigurationValidationId">;
...
export type ConfigurationReferenceId = Brand<string, "ConfigurationReferenceId">;
...
function brandId<T extends string>(value: string): T {
  if (!isPlatformConfigurationIdShape(value)) {
    throw new Error(`Invalid platform configuration identifier shape: ${value}`);
  }
  return value as T;
}
...
export function asConfigurationNamespaceId(value: string): ConfigurationNamespaceId {
  return brandId(value);
}
export function asConfigurationGroupId(value: string): ConfigurationGroupId {
  return brandId(value);
}
export function asConfigurationVersionId(value: string): ConfigurationVersionId {
  return brandId(value);
}
export function asConfigurationOverrideId(value: string): ConfigurationOverrideId {
  return brandId(value);
}
export function asConfigurationValidationId(value: string): ConfigurationValidationId {
  return brandId(value);
}
export function asConfigurationAuditId(value: string): ConfigurationAuditId {
  return brandId(value);
}
export function asConfigurationHistoryId(value: string): ConfigurationHistoryId {
  return brandId(value);
}
export function asConfigurationReferenceId(value: string): ConfigurationReferenceId {
  return brandId(value);
}
export function asConfigurationMetadataId(value: string): ConfigurationMetadataId {
  return brandId(value);
}

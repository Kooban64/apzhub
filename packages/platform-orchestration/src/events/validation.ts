...
const PAST_TENSE_TOKEN =
  /(created|completed|started|stopped|paused|resumed|received|ignored|routed|rejected|produced|submitted|registered|versioned|transitioned|failed|cancelled|superseded|deferred|emitted|published|recorded|ready|updated|identified|associated|normalized)$/i;

...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.11" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-012" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S12" as const;

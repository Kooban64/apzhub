...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.13" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-014" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S14" as const;

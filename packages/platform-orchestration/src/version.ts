...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.15" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-016" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S16" as const;

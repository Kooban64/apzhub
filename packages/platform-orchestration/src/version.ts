...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.16" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-017" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S17" as const;

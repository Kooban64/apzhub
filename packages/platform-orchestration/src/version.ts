...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.4" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-005" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S05" as const;

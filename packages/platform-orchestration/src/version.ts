...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.14" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-015" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S15" as const;

...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.9" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-010" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S10" as const;

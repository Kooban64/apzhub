...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.10" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-011" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S11" as const;

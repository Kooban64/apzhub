...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.5" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-006" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S06" as const;

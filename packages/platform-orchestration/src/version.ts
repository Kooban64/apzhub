...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.7" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-008" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S08" as const;

...
export const PLATFORM_ORCHESTRATION_VERSION = "0.1.12" as const;
...
export const PLATFORM_ORCHESTRATION_SLICE = "QO-013" as const;
export const PLATFORM_ORCHESTRATION_LEGACY_SLICE = "S13" as const;

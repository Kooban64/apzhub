...
const projectsManifestPaths = [
  ...
  "services/projects/manifests/projects-dashboard/module.yaml",
  "services/projects/manifests/projects-list/module.yaml",
  "services/projects/manifests/projects-my-work/module.yaml",
  "services/projects/manifests/projects-tasks/module.yaml",
  "services/projects/manifests/projects-backlog/module.yaml",
  "services/projects/manifests/projects-sprints/module.yaml",
  "services/projects/manifests/projects-roadmap/module.yaml",
  "services/projects/manifests/projects-search/module.yaml",
  "services/projects/manifests/projects-help/module.yaml",
  "services/projects/manifests/projects-settings/module.yaml",
  "services/projects/manifests/projects-health/module.yaml",

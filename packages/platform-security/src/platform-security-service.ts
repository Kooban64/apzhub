...
import { getSharedTrafficGovernanceService, TrafficGovernanceService } from "./traffic-governance/traffic-governance-service";
...
export class PlatformSecurityService {
  ...
  constructor(cspApp: "web" | "law-platform" = "web") {
    ...
    this.securityDiagnostics = new SecurityDiagnosticsService(this.cspViolations, cspApp);

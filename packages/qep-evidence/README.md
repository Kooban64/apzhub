...
- Nested deep links: detail / provenance / versions / relationships

## Accepted limitations (CERT-003)

ADR-0088 memory-only · Evidence observability deferred · event publication deferred · L-EM-01 **CLOSED** (S01) · Permission-aware Evidence Query pipeline (S02) · GA not approved

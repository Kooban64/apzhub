/**
 * ProjectsSearchPublicationContext (APZSEARCH-010).
 */
...
export type ProjectsSearchPublicationContext = {
...
export function createProjectsSearchPublicationContext(input: {

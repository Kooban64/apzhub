/**
 * TestingSearchPublicationContext (APZSEARCH-013).
 */
...
export type TestingSearchPublicationContext = {
   ...
   * Fail-closed: defaults to confidential.
   */
...
export function createTestingSearchPublicationContext(input: {

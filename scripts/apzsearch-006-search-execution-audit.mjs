...
assert(
  ["0.18.0", "0.19.0", "0.25.0", "0.30.0", "0.32.0"].includes(platformPkg.version),
  "version-platform-services",
  `expected 0.18.0, 0.19.0, 0.25.0, 0.30.0 or 0.32.0 got ${platformPkg.version}`,
);
assert(
...
console.log(
  "  versions: search-contracts@0.4.0 platform-services@0.32.0 integration-meilisearch@0.1.0",
);
console.log(
